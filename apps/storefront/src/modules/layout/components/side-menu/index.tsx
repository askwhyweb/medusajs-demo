                  ...
                  >
                    ...
                    {topLevelCategories?.length ? (
                      <div className="flex flex-col gap-4 mt-10">
                        <span className="text-sm uppercase tracking-[0.08em] text-ui-fg-subtle">
                          Categories
                        </span>
                        <ul className="flex flex-col gap-4 items-start justify-start">
                          {topLevelCategories.slice(0, 6).map((category) => {
                            const children =
                              category.category_children?.slice(0, 6) || []
                            ...
                            return (
                              <li key={category.id} className="flex flex-col gap-2">
                                ...
                                {children.length ? (
                                  <ul className="flex flex-col gap-2 pl-4 text-base text-ui-fg-subtle">
                                    {children.map((child) => (
                                      <li key={child.id}>
                                        <LocalizedClientLink
